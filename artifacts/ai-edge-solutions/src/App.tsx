...
const BBBContentAutopilotPage = lazy(() => import("./pages/BBBContentAutopilotHealthPage"));
...
const ProofPackPage = lazy(() => import("./pages/ProofPackPage"));
...
function AppRouter() {
  return <Suspense fallback={<PageLoader />}><Switch>
    ...
    {isSecretsPreviewAvailable(import.meta.env.DEV) && <Route path="/secrets-preview"><Suspense fallback={<PageLoader />}><SecretsPage developmentPreview /></Suspense></Route>}
    ...
    <Route path="/admin/proof-pack"><Authenticated><ProofPackPage /></Authenticated></Route>

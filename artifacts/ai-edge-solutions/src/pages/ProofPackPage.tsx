...
const labels: Record<string, string> = { leadsCaptured: "Leads captured", missedCalls: "Missed calls", successfulRecovery: "Successful recovery", customerResponses: "Customer responses", bookings: "Bookings", completedJobs: "Completed jobs", verifiedRevenue: "Verified revenue", attributableRevenue: "Attributable revenue", reviewsObserved: "Reviews observed", averageRating: "Average rating", referralsCreated: "Referrals created", referralRevenue: "Referral revenue", contentCreated: "Content created", contentPublished: "Content published", unresolvedRevenueLeaks: "Unresolved revenue leaks" };

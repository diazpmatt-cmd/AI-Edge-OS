      ...
      <div style={SECTION_STYLE}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10, marginBottom: 16 }}>
          {[
            ...
            { label: "Simulate Call → Press 3", desc: "Voicemail recorded + SMS alert sent", icon: "🎙", sel: "3", color: "#3B82F6" },
          ].map(btn => (
            <button
              key={btn.sel}
        ...
        <div style={{ marginTop: 14, padding: "10px 14px", borderRadius: 10, background: "rgba(0,174,239,0.04)", border: "1px solid rgba(0,174,239,0.1)" }}>
          <div style={{ fontSize: 10.5, color: "#475569", lineHeight: 1.7 }}>
            ...
            Greeting plays → Press 1: live transfer to (251) 324-9090 · Press 2: callback lead logged · Press 3: Telnyx records voicemail, SMS alert sent to (251) 324-9090
            <br />

...
export async function buildLeadRecoveryReadiness(clientId: string) {
  ...
  return Object.freeze({
    ...
    communicationEndpoint: Object.freeze({
      found: !!endpoint,
    ...
    recoveryOwnership: Object.freeze({
      schedulerEnabled,
      immediateWebhookOwner: true,
      duplicateOwnerRisk: schedulerEnabled,
    }),
    safetyMaintenance: Object.freeze({

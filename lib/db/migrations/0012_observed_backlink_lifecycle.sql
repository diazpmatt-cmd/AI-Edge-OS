-- Measurement Engine: authoritative observed-client-backlink lifecycle persistence.
-- Additive only. Authority opportunity evidence/ingestion tables remain unchanged.
